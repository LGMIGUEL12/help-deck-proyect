import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, shallowRef, h, resolveComponent, toRef, isRef, computed, mergeProps, withCtx, renderSlot, createBlock, createCommentVNode, openBlock, toDisplayString, hasInjectionContext, inject, getCurrentInstance, useAttrs, toValue, provide, createVNode, resolveDynamicComponent, onServerPrefetch, ref, nextTick, unref, defineAsyncComponent, Suspense, Fragment, createElementBlock, cloneVNode, useSSRContext, watch, createApp, shallowReactive, watchEffect, onErrorCaptured, reactive, effectScope, isReadonly, isShallow, isReactive, toRaw, getCurrentScope, createSlots, renderList } from 'vue';
import { z as serialize, A as parseQuery, f as createError$1, v as hasProtocol, B as isScriptProtocol, y as joinURL, C as defuFn, w as withQuery, D as sanitizeStatusCode, E as withTrailingSlash, F as withoutTrailingSlash, G as defu, H as createDefu, I as getContext, J as klona, K as isEqual, $ as $fetch$1, L as baseURL, M as createHooks, N as executeAsync, O as toRouteMatcher, P as createRouter$1 } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "home",
    path: "/home",
    component: () => import('./home-D7zlZeRn.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    meta: { "middleware": "admin" },
    component: () => import('./admin-Bb14amKD.mjs')
  },
  {
    name: "index",
    path: "/",
    ...
    redirect: "/home",
    component: () => import('./index-URhKXIr3.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-B1GDcQhd.mjs')
  },
  {
    name: "users",
    path: "/users",
    meta: { "middleware": "admin" },
    component: () => import('./users-ClgVRezF.mjs')
  },
  {
    name: "tickets",
    path: "/tickets",
    meta: { "middleware": "auth" },
    component: () => import('./tickets-CSo8zWr0.mjs')
  },
  {
    name: "historia",
    path: "/historia",
    meta: { "middleware": "auth" },
    component: () => import('./historia-CHpVUH1E.mjs')
  },
  {
    name: "seed-tickets",
    path: "/seed-tickets",
    component: () => import('./seed-tickets-Cvvt2vIH.mjs')
  },
  {
    name: "test-tickets",
    path: "/test-tickets",
    component: () => import('./test-tickets-7gRg-MyP.mjs')
  }
];
...
const namedMiddleware = {
  admin: () => import('./admin-CiGJnbNY.mjs'),
  auth: () => import('./auth-CXMpb5f8.mjs')
};
...
const __nuxt_component_1$3 = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["ssrRender", _sfc_ssrRender$6]]);
...
const __nuxt_component_1$2 = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$5]]);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BV0mFBTh.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-i2p15Vyf.mjs'));
...
export { _export_sfc as _, __nuxt_component_0$2 as a, __nuxt_component_1$1 as b, __nuxt_component_1$3 as c, useState as d, entry$1 as default, defineNuxtRouteMiddleware as e, createError as f, navigateTo as n, useHead as u };
